  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${baseUrl}/voice-agent/calls/house-of-zen`,
        {
          method: "POST",
          headers: {
        ...
        <div className="card mx-auto max-w-3xl p-8 bg-blue-50 border border-gray-200 shadow-md rounded-lg">
          <div className="card-body">
            ...
            <p className="mb-8 text-center">
              Please fill out the form below to book an appointment with House
              of Zen Clinic. Our AI voice agent will contact you shortly to
              confirm the details.
            </p>
